...
### dbt
**What is it:** A transformation framework that allows me to write modular SQL to turn raw data in BigQuery into clean, modeled tables for analysis.
**Key takeaways:** I used dbt to handle the "T" in ELT (Extract, Load, Transform); it allows me to apply version control, testing, and documentation to my data warehouse, ensuring that complex NYC taxi data is standardized and reliable before it reaches any dashboards.
